  ...
  return (
    ...
    >
      <div className="bg-white/90 backdrop-blur-sm shadow-lg rounded-lg px-4 py-2 text-sm text-gray-800 border border-orange-200">
        <span className="font-medium text-orange-600">© 2024</span>{' '}
        <span className="font-medium">Created by Aditya Ramesh Vispute</span>
        <span className="block text-xs text-gray-600">All Rights Reserved</span>
      </div>
    </motion.div>
  );
};
